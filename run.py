...
class CVLabCleaningAssignment:
    ...
    def _init_area(self):
        ...
        area["왼쪽(창고)쪽 복도, 신발장, 옷장"] = 2
        area["오른쪽 복도, 신발장, 옷장"] = 2
        area["냉장고 정리 (유통기한 만료, 이름 없는 것들), 얼룩제거"] = 2
        area["전자레인지 안/밖 닦기, 소파 먼지 털고 오기"] = 2
        area["파쇄기 비우기, 프린터 주변 청소, 청소 후 청소기 잔여물 제거"] = 2
        area["창가 정리 및 먼지 닦기, 창가쪽 복도 닦기"] = 2
        return area
